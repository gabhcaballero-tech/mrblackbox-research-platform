...
import { getParticipantPortalPublicResult } from "@/modules/participant-portal/screener-service";
import { participantPortalStudyCodeSchema } from "@/modules/participant-portal/validation";
import { ParticipantPortalResultCard } from "../filtro/ParticipantScreenerForm";
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-zinc-50 px-4 py-10">
      <div className="w-full max-w-md">
        <ParticipantPortalResultCard result={result.data} />
      </div>
    </main>
  );
}
