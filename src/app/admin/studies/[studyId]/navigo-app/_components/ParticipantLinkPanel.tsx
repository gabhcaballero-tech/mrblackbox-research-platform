...
export function ParticipantLinkPanel({ testUrl, url }: ParticipantLinkPanelProps) {
  ...
  const message = `Hola, gracias por participar en el estudio Navigo Homme. Para realizar tus evaluaciones de fragancia a 0, 2, 4 y 6 horas, entra a este enlace: ${url}. Por favor conserva este mensaje y realiza cada evaluacion cuando corresponda.`;
