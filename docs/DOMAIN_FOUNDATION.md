...
- `navigo-app`: fundacion tecnica para mediciones T0, 2 h, 4 h y 6 h de Navigo.
...
- Las actividades usan offsets y ventanas configurables; los offsets de prueba cubren 15, 120, 240 y 360 minutos.
- Las actividades recurrentes usan `occurrenceKey` para permitir varias instancias del mismo schedule.
- Navigo Fase 1 usa codigos estables de schedule `T0_SALON`, `T2_HORAS`, `T4_HORAS` y `T6_HORAS`.
